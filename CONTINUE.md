...
```bash
java -cp \
  hypermixins-example/build/libs/hypermixins-example-1.8.jar:\
hypermixins-runtime/build/libs/hypermixins-runtime-1.8.jar:\
hypermixins-annotations/build/libs/hypermixins-annotations-1.8.jar:\
