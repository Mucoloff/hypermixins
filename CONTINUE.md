...
./gradlew :hypermixins-runtime:test                       # 125 tests: dispatch, inject, reload, @Local, @Final/@Mutable, @Soft, @Implements, @Slice, @Unique, @Wrap*, @Shift.BY, @Coerce, Args, @Share, @Inject(require/allow), YAML
