...
./gradlew :hypermixins-runtime:test                       # 127 tests: dispatch, inject, reload, @Local, @Final/@Mutable, @Soft, @Implements, @Slice, @Unique (static + instance), @Surrogate, @Wrap*, @Shift.BY, @Coerce, Args, @Share, @Inject(require/allow), YAML
