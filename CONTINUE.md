...
./gradlew :hypermixins-runtime:test                       # ~136 tests: dispatch, inject, reload, @Local, @Final/@Mutable, @Soft, @Implements, @Slice, @Unique (static + instance), @Surrogate, @Definition/@Expression, @Wrap*, @Shift.BY, @Coerce, Args, @Share, @Inject(require/allow), YAML
